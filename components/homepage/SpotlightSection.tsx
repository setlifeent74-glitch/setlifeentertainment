  ...
  return (
    <ScrollReveal as="section" className="spotlight-section">
      ...
      <div className="spotlight-copy">
        ...
        <h2 className="spotlight-name display">{post.title}</h2>
