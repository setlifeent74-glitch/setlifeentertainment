...
-- §45 admin login — the "one shared credential" for local dev and CI E2E
-- testing only. Local-only fixture, same as everything else in this file;
-- the real production admin account is a separate step the owner takes
-- (or asks for) once the project is provisioned on the real Supabase
-- instance — this row never reaches that database.
insert into auth.users (
  ...
  '00000000-0000-0000-0000-00000000ad31',
  'authenticated',
  'authenticated',
  'admin@setlifeentertainment.local',
  crypt('SetLifeAdminLocal2026!', gen_salt('bf')),
  now(),
...
insert into auth.identities (
  ...
  '00000000-0000-0000-0000-00000000ad31',
  '00000000-0000-0000-0000-00000000ad31',
  '{"sub":"00000000-0000-0000-0000-00000000ad31","email":"admin@setlifeentertainment.local"}',
  'email',
  now(), now(), now()
)
on conflict do nothing;
